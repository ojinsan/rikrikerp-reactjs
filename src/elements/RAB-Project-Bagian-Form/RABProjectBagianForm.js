...
const RABProjectBagian = (props) => {
  ...
  const onSubmit = () => {
    ...
    Pform.validateFields(["jenis", "bagian"])
      .then(async (valid) => {
        ...
        >
          <Row gutter={16}>
            <Col span={8}>
              ...
              >
                <Select placeholder="Pilih jenis" onChange={(e) => setJenis(e)}>
                  {["RAB", "BQQ"].map((name) => (
            ...
            <Col span={24}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Keterangan Judul Rekap harus terisi",
                  },
                ]}
              >
                <Input.TextArea
                  ...
                  onChange={(e) => setKeteranganJudulRekap(e.target.value)}
                />
              </Form.Item>
            </Col>
          </Row>
            ...
            <Col span={24}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Keterangan Bagian Bawah harus terisi",
                  },
                ]}
              >
                <Input.TextArea
                  ...
                  onChange={(e) => setKeteranganBagBawahRab(e.target.value)}
                />
              </Form.Item>
            </Col>
          </Row>

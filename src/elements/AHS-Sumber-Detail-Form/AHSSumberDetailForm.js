        ...
        try {
          ...
          try {
            ...
            const response = await fetch(
              hostname + "/data-source/post-new-ahs-sumber-detail/",
              {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
              console.log("berhasil ahs sumber detail form, response ok");
              ...
              <Col span={24}>
                ...
                >
                  <Input
                    ...
                    onChange={(e) => setNamaAHSD(e.target.value)}
                  />
                </Form.Item>
              </Col>
            </Row>
              ...
              <Col span={8}>
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Satuan AHS Detail harus terisi",
                    },
                  ]}
                >
                  <Input
                    style={{ width: "100%" }}
                    placeholder="Satuan"
                    onChange={(e) => setSatuanAHSD(e.target.value)}
                  />
                </Form.Item>
              </Col>
              <Col span={8}>
              ...
              <Col span={24}>
                ...
                >
                  <Input.TextArea
                    ...
                    onChange={(e) => setDeskripsiAHSD(e.target.value)}
                  />
                </Form.Item>
              </Col>
            </Row>
